...
return [
    ...
    'make_this_a_required_question' => 'Сделать эту опцию обязательной',
    'no_answers' => 'Извините, на этот вопрос пока нет ответов.',
    'no_questions_yet' => 'Пока нет вопросов',
    'no_questions_yet_text' => 'Здесь вы можете добавить вопросы, на которые посетителям будет предложено ответить в процессе регистрации.',
    'question' => 'Вопрос',
